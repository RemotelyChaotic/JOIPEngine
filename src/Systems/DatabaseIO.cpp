...
class CDatabaseIODesktop : public CDatabaseIO
{
public:
  CDatabaseIODesktop(CDatabaseManager* pManager, std::shared_ptr<CDatabaseData> spData) :
    CDatabaseIO(pManager, spData),
    m_spSettings(CApplication::Instance()->Settings())
  {
  }
  ~CDatabaseIODesktop() override {}
...
class CDatabaseIOAndroid : public CDatabaseIO
{
public:
...
{
#if defined(Q_OS_WIN) || defined(Q_OS_UNIX) && !defined(Q_OS_ANDROID)
  return std::make_unique<CDatabaseIODesktop>(pManager, spData);
#elif defined(Q_OS_ANDROID)
  return std::make_unique<CDatabaseIOAndroid>(pManager, spData);
#endif
}
