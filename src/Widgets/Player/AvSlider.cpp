...
CAvSlider::CAvSlider(QWidget *parent):
    QSlider(parent)
{
...
inline int CAvSlider::pick(const QPoint &pt) const
{
    return orientation() == Qt::Horizontal ? pt.x() : pt.y();
}

// Function copied from qslider.cpp and modified to make it compile
void CAvSlider::initStyleOption_Qt430(QStyleOptionSlider *option) const
{
    if (!option)
        return;
...
// Function copied from qslider.cpp and modified to make it compile
int CAvSlider::pixelPosToRangeValue(int pos) const
{
...
void CAvSlider::enterEvent(QEvent *event)
{
    emit onEnter();
    QSlider::enterEvent(event);
}

void CAvSlider::leaveEvent(QEvent *e)
{
    emit onLeave();
    QSlider::leaveEvent(e);
}

void CAvSlider::mouseMoveEvent(QMouseEvent *e)
{
...
void CAvSlider::mousePressEvent(QMouseEvent *e)
{
